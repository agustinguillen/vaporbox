...
class ChatComponent {
    constructor(_route, _router, _userService, _followService, _messageService) {
        ...
        this.socket = Object(socket_io_client__WEBPACK_IMPORTED_MODULE_4__["io"])("ws://vaporbox.herokuapp.com:80");
        this.loading = true;
...
class PublicationsComponent {
    constructor(_route, _router, _userService, _publicationService, _notificationService) {
        ...
        this._publicationService = _publicationService;
        this._notificationService = _notificationService;
        this.socket = Object(socket_io_client__WEBPACK_IMPORTED_MODULE_5__["io"])("ws://vaporbox.herokuapp.com:80");
        this.noMore = false;
        this.loading = true;
        this.identity = this._userService.getIdentity();
        this.token = this._userService.getToken();
...
class NavbarComponent {
    constructor(user, _notificationService, _messageService, _route, _router) {
        ...
        this._route = _route;
        this._router = _router;
        this.socket = Object(socket_io_client__WEBPACK_IMPORTED_MODULE_1__["io"])("ws://vaporbox.herokuapp.com:80");
